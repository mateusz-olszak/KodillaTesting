...
public class CompanyDaoTestSuite {
    ...
    void testFindCompanyWithName(){
        ...
        System.out.println(softwareMachine.getName() + " " + softwareMachineId);
        System.out.println(dataMaesters.getName() + " " + dataMaestersId);
        System.out.println(greyMatter.getName() + " " + greyMatterId);
