...
public class Watcher {
    ...
    @After("execution(* com.kodilla.patterns2.facade.api.OrderFacade.proccessOrder(..))" +
            "&& target(object)")
    public void proccessOrderLogEvent(Object object){
        LOGGER.info("Class logger: " + object.getClass().getName());
    }
